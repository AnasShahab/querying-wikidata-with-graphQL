...
\lukas{make this final! (footnote should be a footnote, fix formatting)}
...
\end{lstlisting}
\end{minipage}
\lukas{shouldnt there be an array in here somewhere?}
